      ...
      body: ListView(
        ...
        children: [
          ...
          Card(child: Padding(padding: const EdgeInsets.all(18), child: Column(children: [
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(value: _type, decoration: const InputDecoration(labelText: 'Type'), items: _assessmentTypes.map((value) => DropdownMenuItem(value: value, child: Text(value))).toList(growable: false), onChanged: _busy || assessment != null ? null : (value) { if (value != null) setState(() => _type = value); }),
            const SizedBox(height: 12),
